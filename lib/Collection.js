...
export default class Collection {
  ...
  async aggregate(pipeline, options) {
    ...
    return (await this.runCommand('aggregate', Object.assign({ pipeline }, options))).result;
  }
  ...
  aggregateCursor(pipeline, options) {
    ...
    return new Cursor(this, this.fullCollectionName, Object.assign({
      aggregate: this.collectionName,
      pipeline: pipeline,
      cursor: {batchSize: 1000}
    }, options), Object.assign({cursor: {batchSize: 1000}}, options));
  }
